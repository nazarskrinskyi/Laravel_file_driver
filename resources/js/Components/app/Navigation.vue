...
<template>
    <nav class="sidebar min-w-[200px]">
        <div class="h-[80px] px-3 flex items-center gap-4">
            ...
            <h2 class="text-xl font-semibold">File Driver</h2>
        </div>
        <div class="px-3">
            <CreateNewDropdown/>

            <div class="py-3">
                <NavLink :href="route('myFiles')" :active="route().current('myFiles')">
                ...
                <NavLink :href="route('trash')" :active="route().current('trash')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="w-6 h-6 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round"
